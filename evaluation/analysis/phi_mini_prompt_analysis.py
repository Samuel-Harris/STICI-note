...
def __():
    ...
    test_results_dir = "phi_mini_prompt_tests"
...
def __(cosine_similarity_scores_with_average, datasets, df, sns):
    ax = sns.heatmap(cosine_similarity_scores_with_average, yticklabels=df["model_path"], xticklabels=datasets + ["average"], cbar_kws={'label': 'Average cosine similarity'})
